...
echo "servername:".$args["servername"];



$blocktemplate = file_get_contents( getenv('HOME')."/bashtools/templates/nginx/domainsetup/nginxdevblock");
$blocktemplate=str_replace("<servername />",$wwwroot."/".$args["servername"],$blocktemplate);
echo $blocktemplate;
